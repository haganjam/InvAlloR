...
vignette: >
  %\VignetteIndexEntry{Overview of the database}
...
```{r}
#eco_dat <- readRDS(url("https://raw.githubusercontent.com/haganjam/InvTraitR/main/database/freshwater_ecoregion_da#ta.rds"))
#print(eco_dat)
```
...
```{r}
#pre_dat <- readRDS(url("https://raw.githubusercontent.com/haganjam/InvTraitR/main/database/preservation_correction#_database.rds"))
#print(pre_dat)
```
